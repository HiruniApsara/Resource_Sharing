  ...
  return (
    <div className="flex min-h-screen">  {/* Changed from h-screen to min-h-screen */}
      ...
      <main className="flex-1 bg-[#F7F8FB] p-6">  {/* Added consistent padding and background */}
        ...
        {/* Content box */}
        <div className="bg-white border rounded-lg p-10 text-center shadow-sm">  {/* Added rounded-lg and shadow-sm */}
          ...
          <button className="bg-[#2094F3] text-white text-sm px-4 py-2 rounded-lg hover:bg-blue-600">
            Explore Resources
          </button>
        </div>
      </main>
